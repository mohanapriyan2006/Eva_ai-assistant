...
const Thinking = () => {
    return (
        <div className='flex flex-col sm:gap-5 sm:m-0 mb-5'>
            <svg height="80px" width="80px" viewBox="0 0 128 128" className="loader-think" style={{ background: 'transparent' }}>
                <defs>
            ...
            <p className='text-center text-[20px] mr-5 text-gray-300'>Thinking . . </p>
        </div>
    )
}
